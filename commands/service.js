...
export default {
    ...
    async execute(interaction, adminManager, warnManager, guildConfig) {
        ...
        // Configuration du système de service (vérifié en premier car il ne requiert pas de configuration préalable)
        if (subcommand === 'setup') {
            ...
            // Chargement de la configuration pour les sous-commandes de service

...
export class CommandHandler {
    constructor(client, adminManager, warnManager, guildConfig, sharedConfig, backupToGitHub, reportManager, banlistManager, blockedWordsManager) {
        this.client = client;
    ...
    async handleCommand(interaction) {
        ...
        try {
            await command.execute(interaction, this.adminManager, this.warnManager, this.guildConfig, this.sharedConfig, this.backupToGitHub, this.reportManager, this.banlistManager, this.blockedWordsManager, this);
        } catch (error) {
            console.error(error);
